...
const forFade: StackCardStyleInterpolator = ({
  current,
}: StackCardInterpolationProps) => ({
...
const TrackStack = () => {
  return (
    <Track.Navigator
      initialRouteName={Routes.TRACK_SCREEN_STATISTICS}
      screenOptions={{ cardStyleInterpolator }}
    >
      <Track.Screen
        name={Routes.TRACK_SCREEN_STATISTICS}
...
const HomeStack = () => {
  return (
    ...
    >
      ...
      />
      <Home.Screen
        name={Routes.TRACK_INFO}
        component={TrackInfoScreen}
        options={customHeader}
      />
      <Home.Screen
        name={Routes.TRACKS_SCREEN}
        component={TracksScreen}
        options={customHeader}
      />
      <Home.Screen
        name={Routes.TRACKS_MAP_SCREEN}
        component={TracksmapScreen}
        options={noHeader}
      />
      <Home.Screen
...
export default ({ alertRef }: Props) => {
  useEffect(() => {
    // @ts-ignore
    const alertListener = EventRegister.addEventListener(
      'alert',
      ({ params }) => {
        try {
