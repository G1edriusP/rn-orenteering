...
const Heart: React.FC<Props> = ({ size, color = colors.DARK_GREEN, isSelected }) => {
  return (
    <Svg width={size} height={size} fill={isSelected ? color : 'none'} strokeWidth='1.5' viewBox='0 0 24 24'>
      <Path
        stroke={color}
