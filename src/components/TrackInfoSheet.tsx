...
const TrackInfoSheet = forwardRef<TrackInfoHandle, Props>(
  ({ topSnap, headerPos, fromMap = true, fullScreen = false }, ref) => {
    ...
    const onRatingSet = (index: number) => {
      ...
      setRating(old => ({ ...old, selectedRating: index + 1, peopleRated: newPeopleCount, rating: newRating }));
          ...
          <FlatList
            ...
            ListFooterComponent={
              <>
                ...
                <View style={{ flexDirection: "row", marginBottom: padding.MEDIUM + padding.MIDI }}>
